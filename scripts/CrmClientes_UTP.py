...
base_name = f"CrmClientes_UTP"  # Insere RUN_ID e deixa entre parentesês assim: CrmClientes_UTP_{RUN_ID}
...
WITH FonteTratada AS (
    ...
    WHERE Email IS NOT NULL
          AND CPF IS NOT NULL
          AND FonteDados NOT IN ('ClubeGiro', 'Zoox')  -- Filtragem precoce
...
-- CTE para seleção de clientes UTP
ClientesUTP AS (
    SELECT
        FonteDados,
        Nome,
